...
| 参数名 | 必选 | 类型 | 说明 | 示例 |
| --- | --- | --- | --- | --- |
| mobileType | 是 | string | 云手机类型，可设置</br>Android 9</br>Android 10</br>Android 11</br> Android 12</br> Android 13</br> Android 14</br> Android 15</br>Android 16 | Android 10 |
|chargeMode|否|integer|计费模式，0-按需，1-包月，默认为按需|0|
|region|否|string|指定云手机所在的机房，可选参数：cn(中国大陆), sgp(新加坡)，us(美国，目前只支持Android 15)| cn|
...
|proxyQueryChannel|否|integer|代理检测渠道，使用proxyInformation时生效，1-ip-api，2-IP2Location，默认为2|2|
