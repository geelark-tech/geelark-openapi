...
### 2026.02.25
- Add get the current subscription plan information API.
- Add a new request parameter fileName to theCreate material API.
...
### 2026.02.06
- Add Get profiles list, Upgrade plan API

### 2026.02.04
- Android 14 supports app keep-alive
- TikTok AI-generated random comments support specifying links.
- Added browser task interface

### 2026.01.27
-  Add request parameters to the Get all cloud phones API：proxyIds

### 2026.01.26
- Add response parameters to the Get all cloud phones API: deviceName netType language province city

### 2026.01.23
-  Added new parameters to the cloud phone startup API: energySavingMode

### 2026.01.21
- Added device name parameter to the new cloud phone interface
- Instagram Reels video and Reels photo album publishing interfaces now support AI tagging
- Added settings for team app keep-alive and auto-start interfaces
- Added app installation callback

### 2026.01.20
- Add Cloud Phone Batch Import Contacts API

### 2026.01.19
- Add Cloud Phone [Error Code](https://open.geelark.com/api/cloud-phone-error-codes) Summary
- Add Balance Inquiry API
...
### 2026.01.07
- Instagram releases Reels video interface supporting the same URL and volume parameters
- Instagram releases Reels album interface supporting the same URL parameters
...
### 2025.12.24
- The cloud phone startup interface returns the billing type.
- Error codes for adding device models in the cloud phone startup and new cloud phone V2 interfaces.
- Added task creation and task completion callbacks.
- Added an update interface for the data assistant account.

### 2025.12.19
- Add username, ip, event time in start/stop cloud phone callback response data
- Add the hideMirror parameter when starting the cloud phone

### 2025.12.19
- Add cloud phone tag change callback
- Add API for batch operate cloud phone application
...
- Added API for setting team application authorization
- Added API for setting team application ROOT
- New cloud phones support Proxyma/DECODO/NodeMaven/IPIDEAMobile/kookeeyMobile proxies
- The batch query task interface supports filtering by task ID.
- The cloud phone list API response adds the rpaStatus parameter

### 2025.12.15
- Add the hideLibrary parameter when starting the cloud phone

### 2025.12.12
- Add the center parameter when starting the cloud phone

### 2025.12.11
- Added common ADB commands for cloud phones
- Send SMS to cloud phone interface supports Android 14

### 2025.12.10
- Create a new browser and modify it to support passing startup parameters.

### 2025.12.03
- Added new parameters to the cloud phone startup API: width

### 2025.11.28
- Add analytics - get account data API

### 2025.11.26
- The task failed because a custom template task publishing failed.

### 2025.11.12
- When transferring environments, attachments can be transferred.
- Instagram AI account nurturing allows for selectable video viewing counts and supports keyword search.

### 2025.11.03
- Add Proxy Detection API
